...
class PagSeguroConfigWrapper
{
     ...
     *
     */
    const PAGSEGURO_EMAIL = "ithelpdesk24@googlemail.com";
    /**
     *
     */
    const PAGSEGURO_TOKEN_PRODUCTION = "A14EBB80E4314AA4993582CB7722F036";
    /**
     *
     */
    ...
    private static function getCredentials()
    {
        ...
        //$PagSeguroConfig['credentials']['email'] = getenv('PAGSEGURO_EMAIL')            ?: self::PAGSEGURO_EMAIL;
		$PagSeguroConfig['credentials']['email'] = getenv('PAGSEGURO_EMAIL') ? '' : self::PAGSEGURO_EMAIL;
